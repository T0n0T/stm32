...
#define Pixformat_GRAY 3

#define OV5640_DEVICE_ADDRESS 0x78
#define OV5640_ChipID_H 0x300A
#define OV5640_ChipID_L 0x300B
#define OV5640_FORMAT_CONTROL 0x5000
#define OV5640_FORMAT_CONTROL_MUX 0x5001
#define OV5640_JPEG_MODE_SELECT 0x4400
#define OV5640_JPEG_VFIFO_CTRL00 0x4405
#define OV5640_JPEG_VFIFO_HSIZE_H 0x4408
#define OV5640_JPEG_VFIFO_HSIZE_L 0x4409
#define OV5640_JPEG_VFIFO_VSIZE_H 0x440A
#define OV5640_JPEG_VFIFO_VSIZE_L 0x440B
#define OV5640_GROUPACCESS 0x3101
#define OV5640_TIMING_HREF 0x380C
#define OV5640_TIMING_DVPOL 0x380E
#define OV5640_TIMING_DVPHO_H 0x380C
#define OV5640_TIMING_DVPHO_L 0x380D
#define OV5640_TIMING_DVPVO_H 0x380E
#define OV5640_TIMING_DVPVO_L 0x380F
#define OV5640_TIMING_DVHPOL 0x3810
#define OV5640_TIMING_DVSH 0x3814
#define OV5640_TIMING_DVSL 0x3815
#define OV5640_TIMING_DVSDDLY 0x3816
#define OV5640_TIMING_VSYNC0 0x3818
#define OV5640_TIMING_VSYNC1 0x3819
#define OV5640_TIMING_MIRROR 0x3820
#define OV5640_TIMING_FLIP 0x3821
#define OV5640_JPEG_MODE_SELECT 0x4400
#define OV5640_JPEG_MODE_QUALITY 0x4407
#define OV5640_BRIGHTNESS_CONFIG_SIZE 9
#define OV5640_CONTRAST_CONFIG_SIZE 7
#define OV5640_EFFECT_CONFIG_SIZE 4
#define OV5640_AF_CMD_MAIN 0x3008
#define OV5640_AF_FW_STATUS 0x300b
#define OV5640_DELAY_VALUE 5
...
// 3. JPG模式下，数值一定要能被8整除！！
#define Display_Width             240  // 图像长度
#define Display_Height            320 // 图像宽度
